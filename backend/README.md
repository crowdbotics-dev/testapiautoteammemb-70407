...
## Project Structure
    ...
    ├── testapiautoteammemb_70407  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_70407`
...
2. Clone this repo and `cd testapiautoteammemb_70407`
